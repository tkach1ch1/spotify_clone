...
import { HideTextBox, StyledNavBarLi, StyledNavBarLink, StyledNavBarUl } from '../style'
...
export const NavBarCategories = () => {
    ...
    // Takes page pathname to compare it with a NavLink and to change categorie image on active image when user on the page
    useEffect(() => {
